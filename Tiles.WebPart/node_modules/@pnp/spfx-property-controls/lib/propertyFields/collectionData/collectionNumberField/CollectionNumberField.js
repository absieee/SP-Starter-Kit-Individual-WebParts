...
var CollectionNumberField = (function (_super) {
    ...
    function CollectionNumberField(props) {
        ...
        _this.valueChange = function (field, value) { return __awaiter(_this, void 0, void 0, function () {
            var inputVal, validation;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        inputVal = typeof value === "string" ? parseInt(value) : value;
                        return [4 /*yield*/, this.props.fValidation(field, inputVal)];
                    case 1:
                        validation = _a.sent();
    ...
    CollectionNumberField.prototype.render = function () {
        ...
        return (React.createElement("div", { className: PropertyFieldCollectionDataHost_module_scss_1.default.numberField + " " + (this.state.errorMessage ? PropertyFieldCollectionDataHost_module_scss_1.default.invalidField : "") },
            React.createElement("input", { type: "number", role: "spinbutton", placeholder: this.props.field.placeholder || this.props.field.title, "aria-valuemax": "99999", "aria-valuemin": "-999999", "aria-valuenow": this.props.item[this.props.field.id] || '', "aria-invalid": !!this.state.errorMessage, value: this.props.item[this.props.field.id] || '', onChange: function (ev) { return _this.valueChange(_this.props.field, ev.target.value); } })));
    };
