...
var Term = (function (_super) {
    ...
    Term.prototype.render = function () {
        ...
        return (React.createElement("div", { className: TaxonomyPicker_module_scss_1.default.listItem + " " + TaxonomyPicker_module_scss_1.default.term, style: styleProps },
            React.createElement(Checkbox_1.Checkbox, { checked: this.state.selected, disabled: this.props.term.IsDeprecated || this.props.disabled, className: this.props.term.IsDeprecated ? TaxonomyPicker_module_scss_1.default.termDisabled : TaxonomyPicker_module_scss_1.default.termEnabled, label: this.props.term.Name, onChange: this._handleChange })));
    };
    return Term;
}(React.Component));
