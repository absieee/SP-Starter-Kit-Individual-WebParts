   ...
   */
    ...
    TaxonomyPicker.prototype.render = function () {
        ...
        return (React.createElement("div", null,
            ...
            React.createElement("table", { className: TaxonomyPicker_module_scss_1.default.termFieldTable },
                React.createElement("tbody", null,
                    React.createElement("tr", null,
                        ...
                        React.createElement("td", { className: TaxonomyPicker_module_scss_1.default.termFieldRow },
            ...
            React.createElement(Panel_1.Panel, { isOpen: this.state.openPanel, hasCloseButton: true, onDismiss: this.onClosePanel, isLightDismiss: true, type: Panel_1.PanelType.medium, headerText: this.props.panelTitle, onRenderFooterContent: function () {
                    return (React.createElement("div", { className: TaxonomyPicker_module_scss_1.default.actions },
                        React.createElement(Button_1.PrimaryButton, { iconProps: { iconName: 'Save' }, text: "Save", value: "Save", onClick: _this.onSave }),
                        React.createElement(Button_1.DefaultButton, { iconProps: { iconName: 'Cancel' }, text: "Cancel", value: "Cancel", onClick: _this.onClosePanel })));
                } },
